...
(function (root, chic) {
    ...
    Class.extend = function (props) {
        ...
        reopenFlag = isFn(Object.getPrototypeOf(proto).init);

        // Add new properties
        forEachProp(props, function (value, name) {
            if (isFn(value)) {
                var applySuper = applySuperMethod(value, Parent.prototype[name]);
                reopenFlag ? Object.getPrototypeOf(proto)[name] = applySuper : proto[name] = applySuper;
                return;
            }
